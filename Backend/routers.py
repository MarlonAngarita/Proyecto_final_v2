...
from .views import (
    ...
    CursosNivelViewSet,
    DesafiosViewSet,
    DesafiosUsuarioViewSet,
    ForoViewSet,
    GamificacionViewSet,
    MedallasViewSet,
    MedallasUsuarioViewSet,
    ModulosViewSet,
    NivelesUsuarioViewSet,
    ProgresoUsuarioViewSet,
    QuizViewSet,
    RachasUsuarioViewSet,
    RegistroUsuarioView,
...
urlpatterns = [
    ...
    path(
        "api/v1/register/profesor/",
        RegistroProfesorView.as_view(),
        name="register_profesor",
    ),
